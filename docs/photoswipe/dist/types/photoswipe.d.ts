...
export type PhotoSwipeEventsMap =
  import("./core/eventable.js").PhotoSwipeEventsMap;
export type PhotoSwipeFiltersMap =
  import("./core/eventable.js").PhotoSwipeFiltersMap;
export type Bounds = import("./slide/get-thumb-bounds").Bounds;
/**
 * <T>
 */
export type EventCallback<
  T extends keyof import("./core/eventable.js").PhotoSwipeEventsMap,
> = import("./core/eventable.js").EventCallback<T>;
/**
 * <T>
 */
export type AugmentedEvent<
  T extends keyof import("./core/eventable.js").PhotoSwipeEventsMap,
> = import("./core/eventable.js").AugmentedEvent<T>;
export type Point = {
  x: number;
  y: number;
  id?: string | number;
...
export type DataSource =
  | import("./slide/slide.js").SlideData[]
  | DataSourceObject;
...
export type PreparedPhotoSwipeOptions = {
   ...
   */
  getViewportSizeFn?:
    | ((options: PhotoSwipeOptions, pswp: PhotoSwipeBase) => Point)
    | undefined;
  /**
