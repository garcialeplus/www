...
!((n) => {
    ...
    void 0 ===
      (i = (() => {
        ...
        return (
          ...
          (l.prototype.isUndef = (t) => void 0 === t),
          (l.prototype.isFunction = (t) => "function" == typeof t),
          (l.prototype.isNumber = (t) => "number" == typeof t),
          (l.prototype.isObject = (t) =>
            "[object Object]" === Object.prototype.toString.call(t) &&
            t.constructor === Object),
          (l.prototype.isBoolean = (t) => "boolean" == typeof t),
          (l.prototype.isArray = (t) => Array.isArray(t)),
          (l.prototype.isString = (t) => "string" == typeof t),
          (l.noOp = () => {}),
          ...
          (l.prototype.equalPowerScale = (t) => {
            var e = 0.5 * Math.PI;
            return Math.sin(t * e);
          }),
          (l.prototype.dbToGain = (t) => 2 ** (t / 6)),
          (l.prototype.gainToDb = (t) => (Math.log(t) / Math.LN10) * 20),
          (l.prototype.intervalToFrequencyRatio = (t) => 2 ** (t / 12)),
          (l.prototype.now = () => l.context.now()),
          (l.now = () => l.context.now()),
          (l.extend = (t, e) => {
            function n() {}
          ...
          Object.defineProperty(l, "supported", {
            get: () => {
              var t =
                ...
                e = Object.hasOwn(window, "Promise"),
                n = Object.hasOwn(window, "Worker");
              return t && e && n;
            },
          }),
          (l.version = "r10"),
        ...
        (r = ((u) => {
          return (
            ...
            (u.TimelineSignal.prototype._exponentialApproach = (
              ...
              i,
              r,
            ) => n + (e - n) * Math.exp(-(r - t) / i)),
            (u.TimelineSignal.prototype._linearInterpolate = (t, e, n, i, r) =>
              e + ((r - t) / (n - t)) * (i - e)),
            ...
            (i.Context.prototype._defineProperty = function (e, n) {
              this.isUndef(this[n]) &&
                Object.defineProperty(this, n, {
                  get: () => ("function" == typeof e[n] ? e[n].bind(e) : e[n]),
                  set: (t) => {
                    e[n] = t;
                  },
                });
          ...
          return (
            ...
            (s.Emitter.prototype.on = function (t, e) {
              for (var n = t.split(/\W+/), i = 0; i < n.length; i++) {
                var r = n[i];
                (Object.hasOwn(this._events, r) || (this._events[r] = []),
            ...
            (s.Emitter.prototype.off = function (t, e) {
              for (var n = t.split(/\W+/), i = 0; i < n.length; i++)
                if (((t = n[i]), Object.hasOwn(this._events, t)))
            ...
            (s.Emitter.prototype.emit = function (t) {
              if (this._events) {
                ...
                if (Object.hasOwn(this._events, t))
      ...
      void 0 ===
        (r = ((n) => (
          ...
          (n.Time.prototype._unaryExpressions.quantize = {
            regexp: /^@/,
            method: (t) => n.Transport.nextSubdivision(t()),
          }),
    ...
    ((i = [n(0)]),
      void 0 ===
        (r = ((i) => (
          ...
          (i.TimeBase.prototype._noOp = () => 0),
          (i.TimeBase.prototype._defaultExpr = function () {
            return this._noOp;
          }),
          (i.TimeBase.prototype._defaultUnits = "s"),
          (i.TimeBase.prototype._frequencyToUnits = (t) => 1 / t),
          (i.TimeBase.prototype._beatsToUnits = (t) =>
            (60 / i.Transport.bpm.value) * t),
          (i.TimeBase.prototype._secondsToUnits = (t) => t),
          (i.TimeBase.prototype._ticksToUnits = function (t) {
            return t * (this._beatsToUnits(1) / i.Transport.PPQ);
          }),
          (i.TimeBase.prototype._timeSignature = () =>
            i.Transport.timeSignature),
          ...
          return (
            (t.GreaterThanZero = function () {
              ((this._thresh = this.output =
                new t.WaveShaper((t) => (t <= 0 ? 0 : 1), 127)),
  ...
  (t, e) => {
    function l(t) {
      var r = {},
        o = -1;
      (this.parameters.forEach((t, e) => {
        var n = a[++o] || (a[o] = new Float32Array(this.bufferSize));
  ...
  (t, e) => {
    ...
    (window,
      ...
      Object.hasOwn(window, "webkitOfflineAudioContext") &&
        !Object.hasOwn(window, "OfflineAudioContext") &&
    ...
    p5.prototype.isSupported = () => !!i.canPlayType;
    p5.prototype.isFileSupported = (t) => {
      ...
      void 0 ===
        (r = ((r) => {
          ((r.Frequency = function (t, e) {
            ...
            (r.Frequency.prototype._frequencyToUnits = (t) => t),
            (r.Frequency.prototype._ticksToUnits = (t) =>
              1 / ((60 * t) / (r.Transport.bpm.value * r.Transport.PPQ))),
            (r.Frequency.prototype._beatsToUnits = function (t) {
              return 1 / r.TimeBase.prototype._beatsToUnits.call(this, t);
            }),
            (r.Frequency.prototype._secondsToUnits = (t) => 1 / t),
          ...
          return (
            (r.Frequency.A4 = 440),
            (r.Frequency.prototype.midiToFrequency = (t) =>
              r.Frequency.A4 * 2 ** ((t - 69) / 12)),
            (r.Frequency.prototype.frequencyToMidi = (t) =>
              69 + (12 * Math.log(t / r.Frequency.A4)) / Math.LN2),
            r.Frequency
          );
        }).apply(e, i)) || (t.exports = r));
  },
          ...
          return (
            ...
            (u.Expr._Expressions = {
              value: {
                signal: {
                  regexp: /^\d+\.\d+|^\d+/,
                  method: (t) => new u.Signal(r(t)),
                },
                input: {
                  regexp: /^\$\d/,
                  method: (t, e) => e.input[r(t.substr(1))],
                },
              },
              glue: {
                "(": { regexp: /^\(/ },
              ...
              binary: {
                ...
                "-": {
                  ...
                  precedence: 1,
                  method: (t, e) =>
                    1 === t.length ? i(u.Negate, t, e) : n(u.Subtract, t, e),
                },
                "*": {
                  regexp: /^\*/,
                  precedence: 0,
            ...
            (u.Expr.prototype._parseInputs = (t) => {
              var e = t.match(/\$\d/g),
                n = 0;
              if (null !== e)
            ...
            (u.Expr.prototype._replacements = (t) => {
              for (var e = t.shift(), n = 0; n < t.length; n++)
                e = e.replace(/%/i, t[n]);
              return e;
            }),
            (u.Expr.prototype._tokenize = (t) => {
              for (var e = -1, n = []; 0 < t.length; ) {
                var i = r((t = t.trim()));
                (n.push(i), (t = t.substr(i.value.length)));
              }
          ...
          return (
            (t.Abs = function () {
              this._abs =
                this.input =
                this.output =
                  new t.WaveShaper((t) => (0 === t ? 0 : Math.abs(t)), 127);
            }),
          ...
          return (
            (e.Modulo = function (t) {
              (this.createInsOuts(1, 0),
                (this._shaper = new e.WaveShaper(2 ** 16)),
            ...
            (e.Modulo.prototype._setWaveShaper = function (e) {
              this._shaper.setMap((t) => Math.floor((t + 1e-4) / e));
            }),
      ...
      void 0 ===
        (r = ((e) => {
          return (
            ...
            (e.Pow.prototype._expFunc = (e) => (t) => Math.abs(t) ** e),
  ...
  (t, e, n) => {
    ...
    ((p5.prototype.getOutputVolume = () => o.output.gain.value),
      (p5.prototype.outputVolume = (t) => {
        var e =
    ...
    var m = (t, e, n) => {
        ...
        return (
          ...
          (r = i
            .split("\n")
            .filter((t) => !t.match(/(p5.|native code|globalInit)/g))),
          (o.stack = r.join("\n")),
          o
        );
      },
    ...
    p5.prototype.registerMethod("init", function () {
      if (!g) {
        (this.preload || window.preload || (this.preload = () => {}),
    ...
    var q = (() => {
      function o(t, e, n, i) {
        ...
        ((this._onended = () => {}),
          ...
          (this._whileLoading = "function" == typeof i ? i : () => {}),
          (this._clearOnEnd = function (t) {
            var e = t.target;
            ((e._playing = !1),
              e.removeEventListener("ended", this._clearOnEnd),
              this._onended(this),
              this.bufferSourceNodes
                .map((t, e) => e)
                .reverse()
                .forEach((t) => {
                  !1 === this.bufferSourceNodes[t]._playing &&
                    this.bufferSourceNodes.splice(t, 1);
                }),
              0 === this.bufferSourceNodes.length && (this._playing = !1));
          }.bind(this)),
        ...
        ((t, e, n) => {
                    ...
                    if (200 === s.status) {
                      ...
                      R.decodeAudioData(
                        ...
                        (t) => {
                          this.panner &&
                            ((this.buffer = t),
                            this.panner.inputChannels(t.numberOfChannels),
                            n && n(this));
                        },
                        () => {
                          if (this.panner) {
                            var t = new m("decodeAudioData", o, this.url),
                              e =
                      ...
                      if (!this.panner) return;
                      var t = new m("loadSound", o, this.url),
                        e =
                          "Unable to load " +
                          this.url +
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                this._workletNode &&
                  (this._workletNode.disconnect(), delete this._workletNode),
                ...
                (this._workletNode.port.onmessage = (t) => {
                  if ("position" === t.data.name) {
                    ...
                    ((this._lastPos = t.data.position),
                      this._onTimeUpdate(this._lastPos));
                  }
                }),
                (i.buffer = ((t) => {
                  for (
                ...
                i.playbackRate.setValueAtTime(this.playbackRate, t),
                i.connect(this._workletNode),
          ...
          { key: "processPeaks", value: (t, e, n, i) => {} },
          {
            key: "addCue",
            value: function (t, e, n) {
    ...
    function W(t) {
      return (W = Object.setPrototypeOf
        ...
        : (t) => t.__proto__ || Object.getPrototypeOf(t))(t);
    }
    function Z(t, e) {
    ...
    function X(t, e) {
      return (X = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    ((p5.Envelope = function (t, e, n, i, r, o) {
      ...
      (p5.Envelope.prototype.checkExpInput = (t) => (t <= 0 && (t = 1e-8), t)),
    ...
    function lt(t, e) {
      return (lt = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function Tt(t, e) {
      return (Tt = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
          ...
          ((t, e, n) => {
          ...
          })(e, [
            {
              ...
              value: function (e, n) {
                ...
                var t = p.inputSources[this.currentSource],
                  r = {
                    audio: {
                  ...
                  window.navigator.mediaDevices
                    ...
                    .then((t) => {
                      ((this.stream = t),
                        ...
                        this.amplitude.setInput(this.output),
                        e && e());
                    })
                    .catch((t) => {
                      n && n(t);
    ...
    function Bt(t, e, n) {
      return (Bt =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = Vt(t)); );
                return t;
              })(t, e);
              if (i) {
    ...
    function Mt(t, e) {
      return (Mt = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function Xt(t, e) {
      return (Xt = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function Jt(t, e, n) {
      return (Jt =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = Kt(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function te(t, e) {
      return (te = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function ae(t, e, n) {
      return (ae =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = ue(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function ce(t, e) {
      return (ce = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function de(t, e, n) {
      return (de =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = ye(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function me(t, e) {
      return (me = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function xe(t, e, n) {
      return (xe =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = Se(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function Pe(t, e) {
      return (Pe = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
              ...
              value: function () {
                ...
                for (e = 0; e < i; e++)
                  ((t = this._reverse ? i - e : e),
                    (s[e] = (2 * Math.random() - 1) * (1 - t / i) ** r),
                    (a[e] = (2 * Math.random() - 1) * (1 - t / i) ** r));
                this._setBuffer(o);
              },
            },
            {
                    ...
                    if (200 === u.status)
                      a.decodeAudioData(
                        ...
                        (t) => {
                          ...
                          ((e.name = n[n.length - 1]),
                            (e.audioBuffer = t),
                            this.impulses.push(e),
                            this._setBuffer(e.audioBuffer),
                            i && i(e));
                        },
                        () => {
                          var t = new m("decodeAudioData", s, this.url),
                            e =
                              "AudioContext error at decodeAudioData for " +
                              this.url;
                          n && ((t.msg = e), n(t));
                      ...
                      var t = new m("loadConvolver", s, this.url),
                        e =
                          "Unable to load " +
                          this.url +
                          ". The request status was: " +
        ...
        })(t, [
          {
            ...
            value: function (t) {
              ...
              if (!(e - this.tatumTime <= -0.02)) {
                this.prevTick = t;
                (this.syncedParts.forEach((t) => {
                  t.isPlaying &&
                    (t.incrementStep(i),
                    t.phrases.forEach((t) => {
                      var e = t.sequence,
                        n = this.metroTicks % e.length;
                      0 !== e[n] &&
                        (this.metroTicks < e.length || !t.looping) &&
                        t.callback(i, e[n]);
                    }));
                }),
                  (this.metroTicks += 1),
        ...
        function n() {
          ...
          for (var e in arguments)
            ((this.parts[e] = arguments[e]),
              ...
              (this.parts[e].onended = () => {
                (this.resetPart(e), Ie(this));
              }));
          this.looping = !1;
        }
        return (
      ...
      function i(t, e) {
        ...
        this.clock = new Re.a({
          callback: (t) => {
            ...
            0 < e && this.iterations <= this.maxIterations && this.callback(e);
          },
    ...
    function Ze(t, e, n) {
      return (Ze =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = Xe(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function Ye(t, e) {
      return (Ye = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    function on(t, e, n) {
      return (on =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = sn(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function an(t, e) {
      return (an = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    ...
    var fn = (() => {
      ...
      return (
        ((t, e, n) => {
          ...
          { key: "play", value: (t, e, n, i) => {} },
          { key: "triggerAttack", value: (t, e, n) => {} },
          { key: "triggerRelease", value: (t) => {} },
          { key: "amp", value: (t, e) => {} },
          {
            key: "connect",
            value: function (t) {
    ...
    function vn(t, e, n) {
      return (vn =
        "undefined" != typeof Reflect && Reflect.get
          ...
          : (t, e, n) => {
              var i = ((t, e) => {
                for (; !Object.hasOwn(t, e) && null !== (t = _n(t)); );
                return t;
              })(t, e);
              if (i) {
                var r = Object.getOwnPropertyDescriptor(i, e);
    ...
    function gn(t, e) {
      return (gn = Object.setPrototypeOf || ((t, e) => ((t.__proto__ = e), t)))(
        t,
        e,
      );
    }
    var bn = (() => {
      function e() {
        ...
        return (
          ...
          ((t = ((t, e) =>
            !e || ("object" !== dn(e) && "function" != typeof e) ? mn(t) : e)(
            this,
            _n(e).call(this),
          )).oscillator = new nt()),
          (t.env = new ot()),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (t) {
                ...
                for (var a in (this.audiovoices.forEach((t) => {
                  t.triggerRelease(i);
                }),
    ...
    ((p5.prototype.getAudioContext = c.b),
      ...
      (p5.prototype._checkFileFormats = (t) => {
        var e;
        if ("string" == typeof t) {
          var n = (e = t).split(".").pop();
      ...
      (p5.prototype._mathChain = (t, e, n, i, r) => {
        ...
        return new q(
          ...
          () => {
            ("function" == typeof e && e.apply(this, arguments),
              "function" == typeof this._decrementPreload &&
